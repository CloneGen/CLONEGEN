int main () {
    ...
    i < n; i++) {
        ...
        if (d < 0) {
            if ((-b) / (2 * a) != 0.00000)
                cout << fixed << setprecision (5) << "x1=" << (-b) / (2 * a) << '+' << sqrt (fabs (d)) / (2 * a) << "i;" << "x2=" << (-b) / (2 * a) << '-' << sqrt (fabs (d)) / (2 * a) << "i" << endl;
            else
                cout << fixed << setprecision (5) << "x1=" << "0.00000" << '+' << sqrt (fabs (d)) / (2 * a) << "i;" << "x2=" << "0.00000" << '-' << sqrt (fabs (d)) / (2 * a) << "i" << endl;
        }
    }
    return 0;
}
