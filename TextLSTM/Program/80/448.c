int main () {
    ...
    case 8 :
        ...
        break;
    case 9 :
        s2 = d2 + 31 + 28 + 31 + 30 + 31 + 30 + 31 + 31 + a[y2];
        break;
    case 10 :
        s2 = d2 + 31 + 28 + 31 + 30 + 31 + 30 + 31 + 31 + 30 + a[y2];
        break;
    case 11 :
        s2 = d2 + 31 + 28 + 31 + 30 + 31 + 30 + 31 + 31 + 30 + 31 + a[y2];
        break;
    case 12 :
        s2 = d2 + 31 + 28 + 31 + 30 + 31 + 30 + 31 + 31 + 30 + 31 + 30 + a[y2];
        break;
    }
    if (y1 == y2)
        printf ("%d", s2 - s1);
    if (y2 - y1 == 1)
        printf ("%d", 365 + a[y1] - s1 + s2);
    if (y2 - y1 > 1) {
        for (i = y1 + 1; i < y2; i++) {
            s = s + 365 + a[i];
        }
